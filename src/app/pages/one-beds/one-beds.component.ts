...
@Component({
  selector: "app-one-beds",
  templateUrl: "./one-beds.component.html",
  styleUrls: ["./one-beds.component.scss"],
})
export class DisplayOneBedsComponent implements OnInit {
  ...
  constructor(
    private oneBedsServices: DisplayOneBedsService,
